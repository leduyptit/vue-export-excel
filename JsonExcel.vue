  ...
  methods: {
    ...
    jsonToXLS(data) {
      ...
      data.map(function(item, index) {
        var stt = index+1;
        xlsData += "<tr>";
        xlsData += "<td style='padding: 10px'>" + stt + "</td>";
        for (let key in item) {
